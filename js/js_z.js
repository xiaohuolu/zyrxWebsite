...
//自定义
 function jump(id1,id2,n,str){
 	 	if(!isNaN(n)){
 		id1.removeClass(str);
 		id1[n-1].className=str;
 		id2.css("display","none");
 		id2[n-1].style.display="block";
 	}
 }

	function drapDown(id1,id2){
	 id1.hover(function(){
        $(id2[$(this).index()-1]).stop(true).animate({paddingTop:"30px"}).show();

	 },function(){
	 	    $(id2[$(this).index()-1]).stop(true).animate({paddingTop:"50px"}).fadeOut(100);
